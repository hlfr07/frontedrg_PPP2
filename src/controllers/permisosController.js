...
class permisosController {
    ...
    const ruta = req.originalUrl;
      res.render('permisos/permisos', {nombre:permisousuario[0].usuario.nombre, apellido:permisousuario[0].usuario.apellido, perfiles:permisousuario[0].perfiles, token, modulospost: modulospost, tablapost: tablapost, perfilespost: perfilespost, ruta, apiurl: global.apiUrl});
    }
  }
