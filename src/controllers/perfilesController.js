...
class PerfilesController {
    ...
    const ruta = req.originalUrl;
      res.render('perfiles/perfiles', {nombre:permisousuario[0].usuario.nombre, apellido:permisousuario[0].usuario.apellido, perfiles:permisousuario[0].perfiles, ruta, token, apiurl: global.apiUrl});
    }
  }
