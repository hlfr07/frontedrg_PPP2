...
class UsuariobuscarController {
    async showUsuariosbuscar(req, res) {
    ...
    const ruta = req.originalUrl;
      res.render('usuarios/usuariobuscar', {nombre:permisousuario[0].usuario.nombre, apellido:permisousuario[0].usuario.apellido, perfiles:permisousuario[0].perfiles, ruta, apiurl: global.apiUrl});
    }
  }
  module.exports = new UsuariobuscarController();